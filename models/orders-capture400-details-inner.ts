...
/**
 * @type OrdersCapture400DetailsInner
 * @export
 */
export type OrdersCapture400DetailsInner = INVALIDPARAMETERVALUE | MISSINGREQUIREDPARAMETER2 | INVALIDSTRINGLENGTH | INVALIDPARAMETERSYNTAX | MALFORMEDREQUESTJSON;
