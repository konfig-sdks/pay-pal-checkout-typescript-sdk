...
/**
 * @type OrdersTrackCreate422DetailsInner
 * @export
 */
export type OrdersTrackCreate422DetailsInner = CAPTURESTATUSNOTVALID | ITEMSKUMISMATCH | CAPTUREIDNOTFOUND | MSPNOTSUPPORTED;
